...
Test classes:
    ...
    TestGoldenText   — exact golden-file comparison
"""
...
class TestGoldenText:
    ...
    def test_exact_text_output(self):
        ...
        golden_path = os.path.join(self.FIXTURE_DIR, "golden_text.txt")
        ...
        assert actual == expected, f"Text renderer output has changed. If intentional, regenerate {golden_path}"
