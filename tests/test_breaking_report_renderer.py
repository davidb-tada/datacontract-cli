"""
test_report_renderer — Unit tests for ContractDiffReport
------------------------------------------------------------------
Test classes:
...
Note: _flatten_value and LIST_CONTAINERS tests live in test_breaking_helpers.py
(the canonical home for helpers.py tests).
"""
...
# ---------------------------------------------------------------------------
# Tags — iterable scalar items use value as path segment
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Summary rollup — scalar Added/Removed leaf fields
# ---------------------------------------------------------------------------
