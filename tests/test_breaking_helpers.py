"""
test_breaking_helpers — Unit tests for datacontract/breaking/helpers.py
-----------------------------------------------------------------------
Covers every public symbol in helpers.py:
...
from datacontract.breaking.helpers import (
    LIST_CONTAINERS,
    _flatten_value,
)
