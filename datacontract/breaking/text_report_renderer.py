...
Usage:
    ...
    print(TextContractDiffRenderer(report_data=report_data).render())
"""

from __future__ import annotations

from datacontract.breaking.helpers import LIST_CONTAINERS, _flatten_value
...
class TextContractDiffRenderer:
    ...
    def _detail_table(self, changes: list, val_w: int = 26, width: int = 80) -> list[str]:
        ...
        # Infer missing ancestor rows (same logic as _render_detail_rows)
